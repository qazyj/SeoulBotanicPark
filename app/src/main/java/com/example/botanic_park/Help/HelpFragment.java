    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (helpCode == HelpActivity.HELP_TODAY_PLANT) {
            ...
            switch (page) {
                ...
                case 2:
                    Glide.with(view).load(R.drawable.help_plant_4).centerInside().into(imageView);
                    textView.setText(Html.fromHtml("<b>*도감 등록*</b>"
                            + "<br>이미지 검색을 통해 찾은 식물은<br>자동으로 나의 도감에 등록됩니다." +
                            "<br>오늘의 식물도 이미지 검색을 통해 찾을 수 있어요.<br>"));
                    break;

                case 3:
                    Glide.with(view).load(R.drawable.help_plant_2).centerInside().into(imageView);
                    textView.setText(Html.fromHtml("<b>*도감 정렬*</b>"
                            + "<br>왼쪽 상단에 있는 콤보박스를 누르면<br>식물도감을 획득순, 최신순, 가나다순으로<br>" +
                            "정렬할 수 있어요.<br>"));
                    break;
                ...
                case 4:
                    ...
                    textView.setText(Html.fromHtml("<b>*프로그래스바*</b>"
                            + "<br>상단에 있는 프로그래스바로<br>얼마나 모았는지 확인할 수 있어요.<br>"));
                    break;

                case 5:
                    Glide.with(view).load(R.drawable.help_plant_1_1).centerInside().into(imageView);
                    textView.setText(Html.fromHtml("<b>*나의 도감*</b>"
                            + "<br>오른쪽 상단에 있는 빨간 버튼을 누르면<br>나의 도감 획득 단계를 확인할 수 있어요.<br>"));
                    break;
            }
        }
